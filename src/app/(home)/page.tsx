      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="group rounded-2xl p-6 relative overflow-hidden border border-gray-200 bg-white">
              <div className="relative z-10">
                <div className="mb-4">
                  <span className="bg-cyan-100 text-cyan-700 px-3 py-1 rounded-full text-sm">通用</span>
                </div>
                <h3 className="text-2xl font-bold mb-2">Expo 通用入门</h3>
            ...
            <div className="group rounded-2xl p-6 relative overflow-hidden border border-gray-200 bg-white">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">Supabase 入门</h3>
                <p className="text-gray-600 text-sm mb-4">
            ...
            <div className="group rounded-2xl p-6 relative overflow-hidden border border-gray-200 bg-white">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">Turso 多租户入门</h3>
                <p className="text-gray-600 text-sm mb-4">
